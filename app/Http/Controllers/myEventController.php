...
class myEventController extends Controller
{
    ...
    public function listEventType(Datatables $datatabels){
        ...
        try{
                ...
                ->editColumn('start_date',function($record){
                    return date('d-m-Y-H:i', strtotime($record->start_date));
                })
    ...
    {
        $logs = UserEventLogs::where('event_id',$id)->orderBy('updated_at','DESC')->get();
    ...
    */
    ...
    {
        return Carbon\Carbon::parse($record)->format("M d Y");
    }
