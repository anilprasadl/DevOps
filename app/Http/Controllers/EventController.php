                        ...
                        if ($event->id == Event::STATUS_COMPLETED )
                            {
                                    ...
                                    [
                                        ...
                                        'eventClick' => 'function($events, jsEvent, view) {
                                            ...
                                            $("#status").html(($events.id).charAt(0).toUpperCase()+ $events.id.slice(1).toLowerCase());
                                            {$("#assigned_user").html($events.user_name.name.charAt(0).toUpperCase()+ $events.user_name.name.slice(1).toLowerCase());}
