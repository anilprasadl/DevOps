...
<head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family='Varela Round', sans-serif;" /> -->
    ...
    <style type="text/css">
        ...
        body {
            font: 15px 'Varela Round', sans-serif; !important;
            font-weight: 10px;
        }
        ...
        .nav .open>a:hover {
            background-color: #54a0ff!important;
            font-family: 15 px 'Varela Round', sans-serif;;
            font-weight: bold;
            transition: .5s;
        }
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ route('login') }}" style="padding:0px;">
                        ...
                        <span class="brand">{{ config('app.name', 'DevOps Release') }}</span>
                    </a>
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="config"><i class="fas fa-cog"></i> Config</a>
                        </li>
                        @endif
                        <li class="nav-item">
                            <a class="nav-link" href="slots"><i class="fa fa-tasks" aria-hidden="true"></i> My Tasks </a>
                        </li>

                        @endif
                        <li class="nav-item">
                            <a class="nav-link" href="events"><i class="fas fa-calendar-alt"></i> Calendar </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="task-track"><i class="fas fa-history"></i> Timeline </a>
                        </li>
                        <li class="nav-item">
                            
                            <a class="nav-link" href="myevents"><i class="fa fa-calendar" aria-hidden="true"> </i> Schedule Task</a>
