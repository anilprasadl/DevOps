                        ...
                        <div class="row">
                            <div class="col-md-9    col-md-offset-1">
                                <form class="cmxform" ng-model="mytasks">
                                    <div class="form-group">
                                        <p>Are you Sure the state is @{{mytasks.state.name}} for the Event</p>
                                        <br>
                                        <br>
                                        <br>
                                        <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-default" data-dismiss="modal">
                                            No</button>
                                        <button type="submit" ng-click="closeConfirmed()" class="btn btn-danger">Yes</button>
                                    </div>
                            </div>
                            </form>
                        </div>
...
<script type="text/javascript">
    ...
    app.controller('bookedslotsController', function($scope, $http, $compile) {
        ...
        $scope.closeTask = function($id, $status) {
            ...
            $scope.delete_msg = 'Are you Sure to change the Status Of the Event';
