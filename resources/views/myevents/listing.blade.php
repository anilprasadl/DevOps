                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                ...
                                <table class="table" id="mytask_listing">
                                    <thead>
                                        <tr>
                                            <th>Name</th>
                                            <th>Date</th>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                ...
                                <table class="table" id="my_deletedtask_listing">
                                    <thead>
                                        <tr>
                                            <th>Name</th>
                                            <th>Date</th>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-9     col-md-offset-1">
                                    ...
                                    <div class="form-group">
                                        <label for="Name">Jira Ticket URL:</label>
                                        <input id="title" type="text" class="form-control" ng-model="addevent.title " required>
                                    </div>
...
<script type="text/javascript">
    var app = angular.module('eventtypeApp', ['moment-picker','ngMaterial']);
    ...
    app.controller('eventtypeController', function($scope, $http, $compile) {
        ...
        $scope.listDeletedEvents = function() {
            $('#my_deletedtask_listing').DataTable({
                processing: true,
                stateSave: true,
                serverSide: true,
                destroy: true,
