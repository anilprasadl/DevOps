                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            &nbsp;&nbsp;<label for="assigned_user">Assigned To:</label>
                                                <!-- </div>
                                                <div class="col-md-2"> -->
                                                <span id="assigned_user" style="text-transform:capitalize !important;" class="modal-body"></span>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <span id="status" style="text-transform:capitalize !important;" class="modal-body" ></span>
                                                <br>
                                            </div>
                                        </div>
                                        <div class="row">
