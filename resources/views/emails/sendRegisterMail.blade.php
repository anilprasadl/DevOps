            ...
            <td class="container" bgcolor="#FFFFFF">
                <div class="content">
                    <table>
                        <tr>
                            <td>
                                <h3 style="padding:7px 0px 7px 0px;">A New User is Registered ,</h3>
                                <p style="padding:15px 0px 15px 0px;">Name:<strong>{{$name}}</strong></p>
                                <p style="padding:15px 0px 15px 0px;">EmailId:<strong>{{$email}}</strong></p>
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
